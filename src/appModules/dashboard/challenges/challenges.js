...
import { Grid, Card, TextField, FormControlLabel, Checkbox } from '@material-ui/core'
...
class Challenges extends React.Component {
    ...
    navigateToPage = (qid, question) => {
        this.props.history.push({
            pathname: `/app/challenges/${qid}`,
            ...
            <div>
                <Grid container>
                    <Grid item md={12} sm={12} xs={12} className="searchbar-grid">
                        <span className="welcome-title">Welcome to Challenges Page</span>
                        <TextField
                            id="outlined-name"
                            type="text"
                        ...
                        <Card className="practice-card-div">
                            <div>
                                {filteredData.map((item, index) => (
                                    <div className="practice-card-text-div" onClick={() => this.navigateToPage(index + `qwerv8jkas1ysukdjhsloduistd${index}sckdb`, item.question)} key={index}>
                                        <span className="pro-question">{item.question}</span>
